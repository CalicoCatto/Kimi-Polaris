...
### 📥 安装说明
目前还在努力上架 Chrome 应用商店和 EDGE 应用商店，信用卡注册好困难 TvT 

下载 Release 中的 Kimi-Polaris-v1.0.0.zip 压缩包，并将其解压成一个普通的文件夹。
(⚠️ 注意：请将该文件夹存放在你电脑中不会被随意删除的地方，例如 D:\软件\KimiPolaris，安装后请勿移动或删除该文件夹)

Chrome 浏览器：在地址栏输入 chrome://extensions/ 进入“管理扩展程序”页面。打开右上角的“开发者模式”，然后点击左侧出现的“加载已解压的扩展程序”按钮，选择刚才解压出来的文件夹即可。

Edge 浏览器：在地址栏输入 edge://extensions/ 进入“扩展”页面。打开左侧的“开发人员模式”，然后点击右上角的“加载解压的扩展”按钮，选择刚才解压出来的文件夹即可。
...
### 一些碎碎念
非常欣喜于 Kimi Palaris 的诞生。

其中有一些功能，例如时间线、文件夹，是 Gemini Voyager 给了我灵感。

也有一些其他的功能，源自于我自己在使用 Kimi 过程所受的烦扰。
